...
if __name__ == "__main__":
    ...
    sp_500 =        ["AAPL", "MSFT", "AMZN", "NVDA", "GOOGL", "META", "GOOG", "TSLA", "AVGO", "JPM", "UNH", "LLY", "V", "XOM", "JNJ", "HD", "MA", "PG", "COST", "ADBE", "ABBV", "MRK", "CVX", "CRM", "PEP", "BAC", "KO", "WMT", "AMD", "NFLX", "ACN", "MCD", 
    ...
    filtered_tickers = [ticker for ticker in sp_500 if ticker not in stock_symbols]

    stock_symbols += filtered_tickers
